...
Each ``ZigZag'' uses combination of LLMs and ATP tools to translate natural language to logic
and back to natural language.
LLM-L+ATP is used to translate the natural language the typed first-order logic in the 
...
The translation is successively checked by ATP tools for syntax errors and type errors (recall 
