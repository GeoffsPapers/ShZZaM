...
Initially LLM-N is optionally used to normalize the text, rewriting to a clear form, breaking
down long sentences, converting metaphors to their literal meaning, etc.
...
In two examples Google used typed extended first-order logic~\cite{SK18}, i.e., with boolean terms.
...
Future work includes adding access to more LLMs, e.g., XAI's \smalltt{grok},
