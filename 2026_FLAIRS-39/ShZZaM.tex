...
the acceptance, convergence, and sequence thresholds (defaults 0.74, 0.94, 0.94), impose limits on
the number of failures in a Zig (default 10), the number of zigzags in a sequence (default 10), 
and the number of sequence repetitions (default 3).
